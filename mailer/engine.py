    ...
    try:
        ...
        for message in prioritize():
            try:
                ...
                if message.subject.encode("utf-8").find("edit-tweet_tweet_text_not_changed") > 0 or message.subject.encode("utf-8").find("edit-tweet_tweet_text_changed") > 0 or message.subject.encode("utf-8").find("edit-tweet_tweet_ERROR_event") > 0:
                    print "skipped"
                else:
                    email = message.email
